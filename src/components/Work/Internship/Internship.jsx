...
const Internship = () => {
  return (
    <div className="internship">
      <h2>Internship at Smart Personnel Consultants (Current)</h2>
      <ul>
        <li>Current two-month internship</li>
        ...
        <li>Reinforced passion for technology's role in diverse industries</li>
      </ul>
    </div>
  );
};
